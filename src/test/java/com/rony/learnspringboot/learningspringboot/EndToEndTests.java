...
public class EndToEndTests {
    ...
    public static void setUp() throws IOException {
        System.setProperty("webdriver.chrome.driver", "G:\\DEV\\Projects\\learning-spring-boot\\ext\\chromedriver.exe");
    ...
    public void homePageShouldWork() throws IOException {
        ...
        assertThat(pageContent)
                .contains("<a href=\"/images/pints.jpg/raw\">");
        WebElement element = driver.findElement(
                By.cssSelector("a[href*=\"pints.jpg\"]")
        );
